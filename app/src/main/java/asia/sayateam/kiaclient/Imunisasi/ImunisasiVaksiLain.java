...
public class ImunisasiVaksiLain extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        selectQuery = new SelectQuery(ImunisasiVaksiLain.this);
    ...
    public void loadData(int id_anak) {
        ...
        cursor = selectQuery.getImunLain(id_anak);
        ...
        adapter = new CustomRecylerViewAdapter(ImunisasiVaksiLain.this, headerData, childData, RowItem.KES_BUMIL);
