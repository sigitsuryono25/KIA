...
public class NewImunisasiVaksinLain extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        saveData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SendDataToServerHandler sendDataToServerHandler = new SendDataToServerHandler(NewImunisasiVaksinLain.this);
                SendDataToServerHandler.sendDataImunVaksiLain sendDataImunVaksiLain = sendDataToServerHandler.new sendDataImunVaksiLain();
                ...
                if (datesWasPick.equalsIgnoreCase("") && coodinateX.equalsIgnoreCase("") && coodinateY.equalsIgnoreCase("")) {
                    Toast.makeText(NewImunisasiVaksinLain.this, "Silahkan Isi kolom imunisasi terlebih dahulu", Toast.LENGTH_SHORT).show();
                } else {
                    if (new ConnectionDetector(NewImunisasiVaksinLain.this).isConnectingToInternet()) {
                        if (DatabaseVariable.modelGetKeteranganImunisasiDanGizi.getHasil().equalsIgnoreCase("")) {
                            sendDataImunVaksiLain.execute();
                        } else {
                            sendDataImunVaksiLain.execute();
                        ...
                        new AlertDialog.Builder(NewImunisasiVaksinLain.this)
        ...
        switch (item.getItemId()) {
            ...
            case R.id.refreshData:
                if (id_anak.contentEquals("") || id_anak.equalsIgnoreCase(null)) {
                    ...
                    new GetImunisasiLain().execute(new String[]{String.valueOf(id_anak)});
    ...
    public void loadDataSpinner() {
        ...
        ArrayAdapter adapter = new ArrayAdapter(NewImunisasiVaksinLain.this, android.R.layout.simple_dropdown_item_1line, strings);
            ...
            for (int j = 0; j < 1; j++) {
                ...
                while (c.moveToNext()) {
                    ...
                    tvH0.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(NewImunisasiVaksinLain.this);
                        ...
                        public void onClick(View view) {
                            ...
                            builder.setPositiveButton("Masukkan Tanggal Imunisasi", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    DatePickerDialog datePickerDialog = new DatePickerDialog(NewImunisasiVaksinLain.this, dateSetListener, year, month, day);
    ...
    public void loadNamaVaksin() {
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(NewImunisasiVaksinLain.this, android.R.layout.simple_dropdown_item_1line, namavaksinList);
    ...
    public void ShowSelected(String date, String coordinate) {
        try {
            ...
            DatabaseVariable.modelInputVaksinLain.setId_anak(id_anak);
            DatabaseVariable.modelInputVaksinLain.setTanggal_pemberian(date);
            DatabaseVariable.modelInputVaksinLain.setNama_vaksin(vaksin);
            DatabaseVariable.modelInputVaksinLain.setCoordinate(coordinate);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public class GetImunisasiLain extends AsyncTask<String, JSONObject, String> {
        ...
        public GetImunisasiLain() {
            insertQuery = new InsertQuery(NewImunisasiVaksinLain.this);
            jsonHander = new JSONHander(NewImunisasiVaksinLain.this);
            deleteQuery = new DeleteQuery(NewImunisasiVaksinLain.this);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(NewImunisasiVaksinLain.this);
